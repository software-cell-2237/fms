...
@section('container')
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Level Two <small>Financial Management System</small>
			</h3>
			<div class="page-bar">
			...
			<div class="portlet box green ">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i> Enter Level Two Data
                    </div>
                    <div class="tools">
                    ...
                    <form class="form-horizontal" role="form">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="hec_code" id="hec_code" class="form-control" placeholder="HEC Code">
                                </div>
                            </div>
                            <div class="form-group">
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet box blue-madison">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-globe"></i>View Level Two Data
                </div>
                <div class="tools">
...
$(document).ready(function() {
    $('#main_code').on('change', function() {
        ...
        $.ajax({
            url: "{{ url('/levelTwo/list') }}", // Update the URL with your controller route
            type: 'GET',
            data: {
